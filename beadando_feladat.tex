...
\begin{document}
    ...
    Ádám úr a regény főszereplője, a passzív ellenállás megtestesítője.
    ...
    \begin{enumerate}[a)]
        ...
        \item\label{itm:Hermine-szokese} Amíg azonban Ankerschmidt Bécsben, illetve Kufsteinben van Aladár ügyében,
            Straff Maxenpfutschot és missz Natalie-t kihasználva megszökteti Hermine\nobreakdash-t és feleségül veszi.
    ...
    \begin{enumerate}[a)]
        ...
        Az új törvények tették lehetővé Corinna számára, hogy dr.~Grisák segítségével kisajátítsa és eladja őket.
...
\end{enumerate}
    ...
    \begin{thebibliography}{}
        ...
        \bibitem{kihagytak} Balla István (2012): Arató: Hoffmannt kihagyták.
            Interjú Arató Lászlóval. \url{fn.hir24.hu}, \emitdate{c}{2012-02-28}
